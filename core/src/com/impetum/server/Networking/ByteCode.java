...
public class ByteCode {
	...
	public static final byte[] AUTHENTICATION = ByteUtils.connectBytes(SIGN, AUTH);
	public static final byte[] DISCONNECTED = {0x44, 0x43, 0x3d};						// DC=
	public static final byte[] MOV		  =  {0x4d, 0x4f, 0x56, 0x3d};					// MOV=
	public static final byte[] ZMOV		  =  {0x5a, 0x4f, 0x56, 0x3d};			// ZOV=
	...
	public static final byte[] ZOMBIE_SPAWN = {0x5a, 0x53, 0x3d};						// ZS=
	public static final byte[] DECREASE_HEALTH = {0x44, 0x48, 0x3d};					// DH=
	public static final byte[] ZOMBIE_DEATH = {0x5a, 0x44, 0x3d};						// ZD=
